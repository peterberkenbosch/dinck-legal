# Meeting Cheatsheet — Woensdag 11 Februari 2026, 12:30

**Locatie**: Van der Meer, Venekoterweg 44, Oosterwolde
**Aanwezig**: Douwine, Marlou, Grady Hofstra, Peter
...
## VEILIGHEIDSCLAUSULE — altijd beschikbaar
...
## ALS ZIJ MET EEN VOORSTEL KOMEN — niet reageren, informatie verzamelen

1. "Kun je dat op papier zetten zodat ik het kan laten toetsen?"
2. "Wat is de tijdlijn?"
3. "Wie is de externe partij en wat is hun rol?"
...
**Constructief**:
> "Bedankt voor het gesprek. Ik vat samen wat we besproken hebben: [samenvatten]. Ik kom schriftelijk terug. Ik stel voor dat we beiden een gespreksverslag opstellen."

**Geen voortgang**:
> "Mijn positie is helder: ik treed af per 1 maart, ik ben bereid KTLO te bespreken op basis van compensatie, en ik verwacht geïnformeerd te worden."

**Onacceptabele druk**:
> "Dit gesprek is niet productief. Ik stel voor dat we schriftelijk verder gaan, via onze adviseurs."

**Opstaan en vertrekken is altijd een optie.**
