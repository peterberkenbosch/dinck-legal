...
Douwine Koopman (persoonlijk)
    ...
    ├─ Voor Dag en Dou B.V. (kinderopvang; schuldeiser €145K; financier Dinck)
    ├─ Bestuurder Dinck B.V.
    └─ Bestuurslid BVOK (branchevereniging)

Marlou Woltmeijer (persoonlijk)
    └─ 66,7% aandeelhouder Dinck B.V. (sinds 7 nov 2025)
         └─ Vriendin + werknemer Douwine (VDenD), e-mail: m.gorter@dagendou.nl
```

### 2.2 Dinck B.V. (KvK 93428359)

| Gegeven | Waarde |
|---------|--------|
| Opgericht | 28 maart 2024 |
| Vestigingsadres | Van Emstweg 85, 8426 BT Appelscha |
...
Op 7 november 2025 droeg Freca B.V. 8 aandelen (66,7%) over aan Marlou Woltmeijer:
- **Koopprijs**: €1,00
- **Koopovereenkomst**: mondeling (geen schriftelijk contract)
- **Akte voorziet in teruglevering**: Art. 3.2 noemt "mogelijke teruglevering" aan Freca
- **Doel**: UBO-uitschrijving zodat Douwine hypotheek kon krijgen
...
|-------------|--------------|--------|
| Freca B.V. | Rekening-courant (leningsovereenkomst) | €402.458 |
| Freca B.V. | Managementvergoeding Freca (apr-nov 2024) | €64.000 |
| Voor Dag en Dou B.V. | Loonkosten 2024 | €145.536 |
| **Totaal** | | **€611.994** |

**Activa**: SaaS-platform (beperkte verkoopwaarde zonder Peter), klantenbestand (ARR €6.4K), minimaal kasgeld.

**Vervangingswaarde platform**: €250.000 — €350.000 (geschat op basis van uren × markttarief)

---

## 3. Juridisch Kader

### 3.1 Statuten Dinck B.V. — Vetorecht

**Art. 8.6 lid 2**: *"Alle besluiten worden unaniem genomen."*

Met 33,3% heeft Peter vetorecht over alle AVA-besluiten: uitgifte aandelen, statutenwijziging, jaarrekening, dividend, benoeming/ontslag bestuurder, goedkeuring investeringen. Geen deal met een externe partij, geen herstructurering, geen emissie kan zonder Peters instemming.

**Art. 6.2**: Statutair voorkeursrecht bij overdracht aandelen. Bij geen overeenstemming over de prijs: waardering door 3 onafhankelijke deskundigen (waarvan minimaal 1 accountant).

*Volledige analyse: `analyse/statuten-analyse.md`*

### 3.2 SHA — Niet-werkend

De SHA is gesloten tussen PHBX Holding en Freca B.V. (28 maart 2024). Freca is geen aandeelhouder meer sinds 7 november 2025. Marlou heeft geen toetredingsovereenkomst getekend.

**Gevolg**: SHA-bepalingen (kooprecht Art. 3.1.h, prijsbepaling, non-concurrentiebeding Art. 7, informatierechten) zijn niet afdwingbaar. Peter zit in een B.V. met een meerderheidsaandeelhouder zonder contractuele afspraken — maar met statutair vetorecht.

*Volledige analyse: `analyse/sha-analyse.md`*

### 3.3 Managementovereenkomsten — Mismatch met bestuurdersontslag

Beide managementovereenkomsten (PHBX ↔ Dinck en Freca ↔ Dinck, 28 maart 2024) zijn identiek:
- €8.000/maand, fulltime beschikbaarheid, onbepaalde tijd, 3 maanden opzegtermijn
- **Art. 3.1**: *"Bij wijzigingen zijn de wijzigingen gelijk voor beide bestuurders"*
- **Art. 4.2**: Dinck vrijwaart de moedervennootschap voor schadeclaims derden
- **Art. 5.1**: Opzegging: 3 maanden schriftelijk

**Kernbevinding**: Het bestuurdersontslag (BW Boek 2) beëindigt de MO (BW Boek 6) niet automatisch. Per 1 maart 2026:
- Peter is geen bestuurder meer
- PHBX is contractueel nog gebonden aan de MO (fulltime beschikbaar, voor €0)
- Vrijwaring (Art. 4.2) en aansprakelijkheidsbeperking (Art. 4.3) blijven actief
- MO niet formeel opgezegd — strategische voorkeur: niet opzeggen

**Art. 3.1 schending**: Het AVA-besluit van 30 november 2024 wijzigt uitsluitend PHBX's fee. Freca's MO wordt niet genoemd. Formeel is Art. 3.1 (gelijke behandeling) niet nageleefd.

*Volledige analyse: `analyse/managementovereenkomst-analyse.md` en `analyse/bestuurdersontslag-vs-managementovereenkomst.md`*

### 3.4 Leningsovereenkomst — Mutual Assured Destruction

**Oorspronkelijk** (28 maart 2024): Freca → Dinck, max €120K, 10 jaar, 5% rente.
**Addendum** (31 december 2024): Verhoogd naar €500K, eerste aflossing uitgesteld naar 28 maart 2026.

**Kritieke bepalingen**:

| Artikel | Inhoud | Risico |
|---------|--------|--------|
| Art. 7.1.a/b | Directe opeisbaarheid bij niet-nakoming aflossing | HOOG — aflossing 28 mrt onmogelijk |
| Art. 7.1.g | Directe opeisbaarheid bij staking bedrijfsuitoefening | HOOG — risico als Peter stopt én platform stilvalt |
| Art. 7.2 | Opeisbaarheid zonder reden (3 maanden opzegtermijn) | HOOG — Freca's nucleaire optie |
| Art. 6 | Zekerheid op eerste verzoek | MEDIUM |
| Art. 11.2 | Automatisch verzuim (geen ingebrekestelling nodig) | Versterkt 7.1.a/b |

**Eerste aflossing 28 maart 2026**: ~€55-75K (1/9e van uitstaand + rente). Dinck kan dit niet betalen. Default leidt tot opeisbaarheid volledige lening.
...
Veertien gedocumenteerde incidenten over zestien maanden tonen een escalerend patroon:

| Fase | Periode | Incidenten | Karakter |
|------|---------|------------|----------|
| **1** | Okt 2024 — sep 2025 | #1 (aandelenoverdracht), #2 (jaarrekening), #3 (fee-stop) | Informatieachterstelling |
...
## 5. De Acute Crisis (6-10 februari 2026)

### 5.1 Tijdlijn

| Datum | Gebeurtenis |
|-------|-------------|
| **6 feb (vr) 18:35** | Douwine e-mail: financiering per direct gestopt; externe partij gesprek dinsdag; meeting woensdag bij Grady |
| **6 feb** | Peter intake Omnius (Maud van der Zee) |
| **8 feb (zo)** | Peter verzendt brief financiële zorgen + bevestigt meeting, vraagt tijdstip |
...
1. **Werknemers**: Salarissen kunnen niet worden betaald. Bij onbetaalde lonen kunnen werknemers faillissement aanvragen. UWV loongarantieregeling vangt werknemers op (max 13 wk achterstallig loon + 6 wk opzegtermijn + 1 jr vakantiegeld/pensioenpremies).

2. **Aflossing 28 maart**: ~€55-75K, onmogelijk te betalen. Automatisch verzuim → volledige lening opeisbaar.
...
4. **Peters bestuurdersaansprakelijkheid**: Beschermd door Beklamel-norm (brief 8 feb documenteert dat Peter niet wenst dat de vennootschap onverantwoorde verplichtingen aangaat) en buitensluiting van besluitvorming (14 incidenten). Douwine's financieringsstop = risico op persoonlijke aansprakelijkheid onder New Holland Belgium-norm.

### 5.3 Douwine's e-mail 6 februari — analyse

Drie elementen verdienen aandacht:

**"Volkomen los van ontwikkelingen bestuur"**: Pre-emptieve ontkenning van verband met Peters ontslag. Timing (5 weken na ontslagbrief, 3 weken voor vertrek) maakt dit ongeloofwaardig.

**"Per direct" financiering beëindigen**: Juridisch vaag. De leningsovereenkomst Freca → Dinck kan niet "per direct" worden opgezegd (Art. 7.2: 3 maanden opzegtermijn). Wat feitelijk stopt: de operationele financiering via VDenD.

**"Verkennende gesprekken" externe partij**: Mede-bestuurder niet geïnformeerd. Na formeel schriftelijk verzoek (8 feb) nog steeds nul informatie (10 feb).
...
### 6.9 Beklamel-norm — Peter beschermd (NIEUW — 11 feb 2026)

**Definitie (HR)**: Bestuurder is aansprakelijk als hij namens de vennootschap verplichtingen aangaat terwijl hij weet dat de vennootschap deze niet kan nakomen. Peters brief van 8 februari 2026 documenteert expliciet dat hij niet wenst dat nieuwe verplichtingen worden aangegaan. De jurist: *"Hiermee heeft u vermoedelijk onbewust zeer goed gehandeld ten aanzien van een potentiële schending van de Beklamel-norm."*
...
### 6.11 Dossier structurele buitensluiting

14 gedocumenteerde incidenten, escalerend over 16 maanden. Grondslag voor Art. 2:343 BW (uittreding vorderen) en Art. 2:345 BW (enquêteprocedure).

### 6.12 Verliesasymmetrie
...
## 7. Peters Juridische Positie — Kwetsbaarheden

### 7.1 Art. 7.1.g trigger (staking bedrijfsuitoefening)

Als Peter stopt met alle werkzaamheden en het platform stilvalt, kan Freca de volledige lening direct opeisen. **Mitigatie**: (a) MO niet opzeggen vermindert staking-signaal, (b) Douwine als bestuurder is verantwoordelijk voor het inhuren van een vervanger, (c) MAD-dynamiek voorkomt daadwerkelijke opeising, (d) Douwine creëert de trigger zelf als zij geen vervanger inhuurt.
...
Niet geverifieerd of Dinck een bestuurdersaansprakelijkheidsverzekering heeft. Douwine's vage dreigingen over aansprakelijkheid (1 feb 2026) zijn door de jurist formeel weerlegd: het aansprakelijkheidsrisico ligt bij Douwine (New Holland Belgium-norm), niet bij Peter (beschermd door Beklamel-norm + brief 8 feb). D&O-verificatie blijft desondanks prudent.

### 7.4 Jaarrekening 2024

Art. 2:248 lid 2 BW: als de jaarrekening niet tijdig is gedeponeerd, geldt een bewijsvermoeden van onbehoorlijk bestuur. Peter was buitengesloten van de financiële administratie — verweer mogelijk maar bewijslast verschuift. **Te verifiëren vóór 1 maart.**

### 7.5 Lopende fulltime verplichting voor €0

Art. 2.3 MO verplicht PHBX om fulltime beschikbaar te zijn. Na 1 maart is Peter technisch in contractbreuk als hij stopt zonder de MO op te zeggen. Schade voor Dinck bij niet-nakoming is echter €0 (fee is nihil). Opschortingsrecht (Art. 6:262 BW) biedt aanvullende bescherming.

---

## 8. Strategische Opties

### 8.1 Optie A: Onderhandelde Exit

Peter onderhandelt aandelenoverdracht tegen faire waarde, met KTLO als hefboom.

| Aspect | Toelichting |
|--------|-------------|
| **Kosten** | Minimaal (geen procedure) |
| **Doorlooptijd** | Weken tot maanden |
| **Hefbomen** | Vetorecht, platformafhankelijkheid, KTLO-weigering |
| **Risico** | Douwine/Marlou werkt niet mee |
| **Geschikt als** | Eerste stap; altijd eerst proberen |

### 8.2 Optie B: Art. 2:343 BW — Uittreding vorderen

Rechter verplicht mede-aandeelhouder om aandelen over te nemen tegen door deskundige vastgestelde prijs.
...
### 8.3 Optie C: Art. 2:345 BW — Enquêteprocedure

Ondernemingskamer onderzoekt beleid Dinck B.V. Voorlopige voorzieningen mogelijk (schorsing bestuurder, benoeming tijdelijk bestuurder).

| Aspect | Toelichting |
|--------|-------------|
| **Kosten** | €25.000 — €75.000+ |
| **Doorlooptijd** | 6-18 maanden |
| **Grondslag** | Wanbeleid: buitensluiting bestuurder, tegenstrijdig belang, schijnconstructie |
| **Voordeel** | Zeer krachtig, snelle voorlopige maatregelen |
| **Nadeel** | Duur, nucleair, uitspraken zijn openbaar |

### 8.4 Optie D: Passief — Aandeelhouder Blijven, Alles Stoppen

Peter stopt alle werkzaamheden per 1 maart. Blijft passief aandeelhouder met vetorecht. Laat de situatie zich ontvouwen.

| Aspect | Toelichting |
|--------|-------------|
| **Kosten** | Nihil |
| **Doorlooptijd** | Onbepaald |
| **Hefbomen** | Vetorecht blokkeert alles; platformdegradatie creëert urgentie |
| **Risico** | Faillissement → aandelen waardeloos (maar Douwine verliest meer) |
| **Geschikt als** | Tussenstap; creëert druk zonder procedurekosten |

### 8.5 Optie E: Offensief via Sommatiebrief (NIEUW — 11 feb 2026)

Formele sommatiebrief aan Freca B.V. met vordering €100K boete (Art. 10 SHA) + aansprakelijkstelling Douwine (New Holland Belgium-norm). Peter biedt kwijtschelding boete + deblokkade vetorecht in ruil voor aandelenovername tegen gewenste prijs.

| Aspect | Toelichting |
|--------|-------------|
| **Kosten** | ~€596-894 excl. BTW (jurist: 4-6 uur × €149/uur) |
| **Doorlooptijd** | Dagen (brief) + weken (reactie/onderhandeling) |
| **Hefbomen** | €100K boetevordering + persoonlijke aansprakelijkheid Douwine + vetorecht |
| **Risico** | Douwine escaleert / weigert; maar juridische positie is sterk |
| **Geschikt als** | **Primaire strategie** — geadviseerd door jurist |
...
| # | Vraag | Antwoord jurist |
|---|-------|-----------------|
| A1 ✅ | Financieringsstop Douwine → aansprakelijkheidsrisico? | New Holland Belgium-norm: Douwine riskeert persoonlijke aansprakelijkheid |
| A2 ✅ | Peters verplichtingen als mede-bestuurder? | Beklamel-norm: brief 8 feb beschermt Peter |
| A4 ✅ | Aandachtspunten meeting? | **Niet gaan** — Grady behartigt Douwine's belangen |
| D1 ✅ | Bestuurdersaansprakelijkheidsrisico? | "Overwegend veilig" |
| D3 ✅ | Douwine's vage dreigingen? | Risico ligt bij Douwine, niet bij Peter |
| E4 ✅ | PHBX als leningpartij? | PHBX is geen partij bij de geldlening |
| E5 🔶 | Tegenstrijdig belang Douwine? | Bevestigd; nog niet volledig uitgewerkt |
| L4c ✅ | SHA kettingbeding als hefboom? | "Belangrijkste onderhandelingstroef" — €100K boete |

### Openstaand — vóór 1 maart

| # | Vraag | Context |
|---|-------|---------|
| A3 | Kan Peter eisen dat geen toezeggingen worden gedaan aan externe partij? | Collegialiteitsbeginsel |
| B1 | Eindigt de MO automatisch bij bestuurdersontslag? | BW Boek 2 vs. Boek 6 |
| B2 | MO wel of niet opzeggen? | Vrijwaring vs. juridische helderheid |
| C1 | Is het AVA-besluit aantastbaar wegens Art. 3.1 schending? | Ongelijke behandeling fee |
| D4 | Is jaarrekening 2024 tijdig gedeponeerd? | Art. 2:248 lid 2 bewijsvermoeden |
| E3 | Addendum aanvechtbaar wegens misbruik omstandigheden? | Art. 3:44 lid 4 BW |
| G1 | Ongerechtvaardigde verrijking vordering haalbaar? | Art. 6:212 BW, ~€108-180K |

*Volledig overzicht: `vragen-advocaat-maud.md`*

---

## 10. Tijdlijn en Deadlines
...
| 14 dec 2025 | Douwine: €190K claim, "chantage", eenzijdige vergadering (incidenten #4-6) |
| 8-22 jan 2026 | Peter: 4 pogingen tot overleg, 0 concrete reacties Douwine |
...
| Bestand | Inhoud |
|---------|--------|
| `analyse/patronenanalyse-buitensluiting.md` | 14 incidenten in juridisch narratief |
| `analyse/memo-jurist-11feb2026.md` | Analyse memo jurist: 3 pijlers, offensieve strategie — **NIEUW 11 feb** |
| `analyse/correspondentie-analyse.md` | Geverifieerde tijdlijn 21 e-mails (incl. 6 feb email + afmelding 11 feb) |
...
| `analyse/concept-akte-teruglevering-analyse.md` | Concept akte teruglevering Marlou → Freca (10 feb 2026) |
...
Alle originele juridische documenten (PDF's) bevinden zich in `files/`. Zie `bestandsoverzicht.md` voor een volledig overzicht.
