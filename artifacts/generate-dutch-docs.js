  ...
  const children = [
    ...
    new Table({
      ...
      rows: [
        ...
        new TableRow({ children: [createCell("30-11-2024", 1800), createCell("AVA: Managementvergoeding op nul gezet (uitdrukkelijk als tijdelijke maatregel) - geantedateerd document, opgesteld na aankondiging 17 dec", 5400), createCell("Financieel", 2160)] }),
        new TableRow({ children: [createCell("17-12-2024", 1800), createCell("Douwine stopt betaling; behandelt tijdelijke maatregel als permanent", 5400), createCell("Incident #3", 2160)] }),
    ...
    new Table({
      ...
      rows: [
        ...
        new TableRow({ children: [createCell("3", 500), createCell("17-12-2024", 1500), createCell("Financiële beslissingen", 2000), createCell("Managementvergoeding eenzijdig gestopt; AVA-besluit was uitdrukkelijk tijdelijk", 5360)] }),
