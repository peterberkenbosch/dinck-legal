...
## Brondocumenten (`files/`)

### Managementovereenkomsten & AVA-notulen

| Bestand | Inhoud |
|---------|--------|
| `getekend-managementovereenkomst-phbx.pdf` | Managementovereenkomst PHBX Holding ↔ Dinck B.V. |
| `getekend-managementovereenkomst-freca.pdf` | Managementovereenkomst Freca B.V. ↔ Dinck B.V. |
| `getekend-notulen-av-phbx-management.pdf` | AVA-notulen goedkeuring MO PHBX |
| `getekend-notulen-av-freca-management.pdf` | AVA-notulen goedkeuring MO Freca |
| `Getekende notulen wijzigen managementovereenkomst.pdf` | AVA-besluit 30 nov 2024 (fee PHBX → nihil) |

### Leningsovereenkomst

| Bestand | Inhoud |
|---------|--------|
| `getekend-overeenkomst-van-geldlening.pdf` | Leningsovereenkomst Freca → Dinck (28 maart 2024) |
| `Getekend Addendum overeenkomst van geldlening tussen Freca B.V. en Dinc B.V..pdf` | Addendum 31 dec 2024 (verhoging naar €500K) |
...
Eerder gegenereerde .docx versies van conceptdocumenten. Gegenereerd via `generate-dutch-docs.js` (Node.js tooling).

| Bestand | Bron |
|---------|------|
| `Ontslagbrief_Bestuurder_Dinck_BV.docx` | `concepten/ontslagbrief-bestuurder.md` |
| `KTLO_Scope_Dinck_BV.docx` | `concepten/ktlo-scope.md` |
| `Gespreksleidraad_Januari_2026.docx` | `concepten/gespreksleidraad.md` |
| `Aanvullende_Overeenkomst_Informatierechten_Aandeelhouder.docx` | `concepten/informatierechten-overeenkomst.md` |
| `Afrondingsoverzicht_KTLO_Scope.docx` | |
