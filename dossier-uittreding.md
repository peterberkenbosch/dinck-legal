...
Peter betaalt maandelijks ~€150 voor:
- Hosting (servers, databases)
- Monitoring
- Developer tools (GitHub)
- SSL certificaten

Deze kosten worden nog niet doorbelast aan Dinck.
...
**KRITIEK**: De SHA tussen PHBX Holding en Freca B.V. is feitelijk waardeloos:

- Freca is geen aandeelhouder meer (sinds 7 nov 2025)
- Marlou is niet toegetreden tot de SHA
- Geen toetredingsovereenkomst getekend

**Gevolg**: SHA-bepalingen (kooprecht, prijsbepaling, non-concurrentie) zijn niet afdwingbaar.

### 2.2 Statuten - KRITIEKE BEVINDING

**Artikel 8.6 lid 2**: "Alle besluiten worden unaniem genomen."

Dit betekent: Peter heeft **vetorecht** over ALLE AVA-besluiten met zijn 33,3%.

| Besluit | Marlou kan dit... |
|---------|-------------------|
| Nieuwe aandelen uitgeven | ❌ NIET zonder Peter |
| Statuten wijzigen | ❌ NIET zonder Peter |
| Jaarrekening vaststellen | ❌ NIET zonder Peter |
| Dividend uitkeren | ❌ NIET zonder Peter |
| Bestuurder benoemen/ontslaan | ❌ NIET zonder Peter |

### 2.3 Ontslagbrief - SHA Verwijzingen

De ontslagbrief (30 jan 2026) bevat SHA-verwijzingen die niet meer gelden.

**Strategische beslissing**: Geen correctie verzonden.

**Reden**:
- Ontslag is eenzijdige rechtshandeling, blijft rechtsgeldig
...
Rabobank weigerde Douwine privé hypotheek vanwege schuldpositie Dinck. Oplossing:
- Aandelen tijdelijk verkopen aan vertrouweling
- Uitschrijven als UBO
...
| Verkoper | Freca B.V. |
| Koper | Marlou Woltmeijer (persoonlijk) |
| Aandelen | 8 stuks (nummers 1-8) |
| Koopprijs | €1,00 |
| Afgesproken terugkoop | €1,50 aan Freca |

### 3.3 Marlou Woltmeijer

| Veld | Gegeven |
|------|---------|
| Naam | Marlou Gorter - Woltmeijer |
| Adres | Kloosterweg 1B, 8424 SH Elsloo |
| Geboren | 7 april 1986, Stadskanaal |
| Burgerlijke staat | Gehuwd |
| E-mail | m.gorter@dagendou.nl |
| Relatie Douwine | Vriendin + medewerker Voor Dag en Dou |
| SHA-binding | GEEN |
...
## 4. Voorstel December 2025

### 4.1 Oorspronkelijk Voorstel (5 december 2025)

| Element | Voorstel |
|---------|----------|
| Equity buyout | €40.000 lump sum |
| Contractor tarief | €62,50/uur (50% van €125) |
| Uren | 10 uur/week |
| Retainer | €2.500/maand vooraf |
| Infrastructuur | €150/maand extra |
| Looptijd | 6 maanden minimaal |
| Opzegtermijn | 1 maand |
| Deadline afronding | 1 april 2026 |

### 4.2 Onderbouwing €40.000
...
"1/3 van equity is niets waard" + claim dat PHBX €190.000 schuld zou hebben (14 december 2025).

**Juridisch onjuist**: Aandeelhouders zijn niet hoofdelijk aansprakelijk voor BV-schulden.

---

## 5. Huidige Positie (Januari 2026)
...
| Datum | Van | Inhoud |
|-------|-----|--------|
| 8 jan | Peter | Verzoek om overleg te plannen, vraagt om data |
| 12 jan | Douwine | Vraagt eerst om "concrete gespreksonderwerpen en uitgangspunten" |
| 13 jan | Peter | Geeft 5-punten positie, stelt voor: do 15 of vr 16 jan, 9:00 |
| 20 jan | Peter | Follow-up: "Ik wacht nog op jullie reactie... Vrijdagochtend a.s. om 9:30" |
| **22 jan 08:50** | **Douwine** | "Je hebt inderdaad gelijk, ook dit is bij mij blijven liggen. Ik ga in overleg met Grady en kom met een aantal data en tijdstippen" |
| **22 jan 08:56** | **Peter** | "Snap dat het is blijven liggen, ik hoor het wel wanneer het in de agenda's past" |
| 23-29 jan | — | *Geen reactie van Douwine* |
| 30 jan | Peter | Ontslagbrief verzonden |

**Conclusie**: Op 22 januari is geen afspraak gemaakt. Douwine beloofde met data te komen na overleg met Grady. Die data zijn nooit gekomen.

### 5.3 Douwine's Bezwaren (1 februari 2026)

**E-mail van Douwine, CC: Grady Hofstra, Marlou Woltmeijer**

#### Feitelijke Onjuistheden

| Haar claim | Realiteit |
|------------|-----------|
| "wat jij op 9 december jl. hebt aangegeven, namelijk een terugtreden per 1 april 2026" | **Dubbel onjuist**: (1) E-mail was 5 december, niet 9 december. (2) Peter schreef "alles uiterlijk 1 april 2026 **geregeld en afgerond**" = deadline voor onderhandelingen, NIET ontslagdatum. |
| "mijn rol als bestuurder en **aandeelhouder**" | Douwine is GEEN aandeelhouder. Freca verkocht aan Marlou op 7 nov 2025. |
| "op 22 januari jl. expliciet afgesproken een gesprek te plannen" | Onjuist. Zij erkende "dit is bij mij blijven liggen" en beloofde met data te komen. Nooit gedaan. |
| "kan en zal ik niet instemmen met uitschrijving" | Instemming niet vereist voor bestuurdersontslag. |

#### De "Financier" Positie - Belangenverstrengeling

Douwine stelt expliciet: *"handel ik niet alleen vanuit mijn rol als bestuurder en aandeelhouder, maar nadrukkelijk ook vanuit mijn positie als financier van Dinck B.V."*
...
#### Haar Formele Posities (uit handtekening)
...
| Dinck BV | Directeur |
| Freca BV | Directeur |
| BVOK (branchevereniging) | Bestuurslid |

#### Impliciete Dreigingen

1. *"verantwoordelijkheden of aansprakelijkheden verdwijnen niet"* → vage aansprakelijkheidsdreiging
2. *"zal ik mijn eigen positie... heroverwegen"* → dreigt ook te vertrekken, Dinck zonder bestuurders
3. *"financiële ontvlechting en afwikkeling"* → suggereert mogelijk opeisen leningen

#### Samenvatting Bezwaren

- "Met deze datum kunnen wij niet akkoord gaan"
- Verwijst naar "afspraak 22 januari" — feitelijk onjuist (zie tijdlijn hierboven)
- Claimt aandeelhouder te zijn — feitelijk onjuist
- Vage dreigingen over "verantwoordelijkheden en aansprakelijkheden"
- Dreigt eigen positie te heroverwegen
- Wil niet instemmen met uitschrijving per 1 maart

### 5.4 Peters Reactie (conceptversie)

Kort, zakelijk, zonder hooks:
- Bestuurdersontslag is eenzijdige rechtshandeling, geen instemming vereist
- Op 22 januari geen concrete afspraak gemaakt
- Douwine zou met data komen, die nooit zijn ontvangen
...
### 6.1 Soft Exit: Behoud Equity + Ontslag Bestuurder

**Wat Peter krijgt**:
- Geen bestuurdersaansprakelijkheid meer
- Geen zorgplicht meer
- Behoud 1/3 equity (potentiële upside)
- Geen non-concurrentiebeding (triggert pas bij verkoop)

**Volgorde**:
1. EERST leveranciersovereenkomst tekenen
2. DAN informatierechten-overeenkomst tekenen
3. DAN pas ontslagbrief versturen

### 6.2 Nuclear Option: Ontslag + Weglopen

**Status na ontslag bestuurder**:
...
1. Januari-gesprek
2. Geen deal? → Ontslag als bestuurder (gedaan)
3. Opzegtermijn uitdienen
4. Per 1 maart: STOP alle werk
5. Douwine/Marlou kooprecht (1 maand)
6. Indien niet gekocht: passief aandeelhouder
7. Dinck zinkt of zwemt

### 6.3 Juridische Opties
...
## 7. Counter-argumenten Reserve

### 7.1 "Aandelen zijn niets waard"
...
**Counter**:
- Accountant kijkt naar boekwaarde, niet vervangingswaarde
- Statuten voorzien in 3 onafhankelijke deskundigen bij geen overeenstemming
- Niet één accountant naar keuze

### 7.3 "Je hebt al €64K ontvangen"

**Counter**:
- €64K voor ~9 maanden = ~€44/uur (ver onder markt)
...
- [x] Informatierechten art. 2:217 BW uitoefenen — verzonden 2 maart 2026, deadline 16 maart
