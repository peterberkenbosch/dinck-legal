...
**Huidige koers**: Ontslag bestuurder per 1 maart → stille aandeelhouder → KTLO-overeenkomst → package deal voor exit.
...
| Onderwerp | Analyse |
|-----------|---------|
| Managementovereenkomsten + AVA | `analyse/managementovereenkomst-analyse.md` |
| Leningsovereenkomst + addendum | `analyse/geldlening-analyse.md` |
| Bestuurdersontslag vs. MO | `analyse/bestuurdersontslag-vs-managementovereenkomst.md` |
...
## Archief — Beantwoorde en achterhaalde vragen
...
**A3.** ❔ **OPEN MAAR MINDER URGENT**: Douwine meldt gesprekken met een "externe partij" komende dinsdag over een "mogelijke samenwerking." Peter is niet geïnformeerd of betrokken. Wat zijn Peters rechten als mede-bestuurder?
> **Status**: Meeting 11 feb heeft plaatsgevonden. Externe partij geïdentificeerd als Jaamo (Rushmir, Jeffrey). Peter is nu op de hoogte. Vraag minder urgent maar kan relevant worden als er toezeggingen zijn gedaan.

**A4.** ✅ **BEANTWOORD (memo 11 feb)**: Grady's dubbele pet en risico's voor Peter bij meeting.
> **Antwoord jurist**: Meeting afgeraden en afgemeld. *"De heer Hofstra behartigt immers de belangen van mevrouw Koopman en is geen onafhankelijke partij."*

**A5.** ✅ **ACHTERHAALD**: Brief financiële zorgen — verzenden vóór meeting?
> **Status**: Brief verzonden 8 februari 2026. Meeting afgemeld 11 feb. Niet meer relevant.

**A6.** ❔ **OPEN MAAR MINDER URGENT**: Informatieplicht jegens werknemers nu financiering is stopgezet.
> **Status**: Na meeting 11 feb: Douwine wil alle werknemers ontslaan. Vraag verschuift — niet meer Peters verantwoordelijkheid na 1 maart.

### B. Managementovereenkomst — samengevoegd in sectie 1

**B1-B2** → Samengevoegd in vraag 1.1.

**B3.** ❔ **NIET MEER ACTIEF**: Kan Dinck stellen dat PHBX een vervanger moet aanwijzen (Art. 2.2)?
> **Status**: Niet relevant als MO niet wordt opgezegd en Peter KTLO doet.

### C. Art. 3.1 Gelijke Behandeling — samengevoegd in sectie 3

**C1-C2** → Samengevoegd in vraag 3.2.

**C3.** ❔ **NIET MEER ACTIEF**: Kan Peter met terugwerkende kracht aanspraak maken op managementfee via Art. 3.1?
> **Status**: Ongerechtvaardigde verrijking-vordering (sectie 1.3) is sterker argument. Fee-terugvordering via Art. 3.1 is subsidiair.

### D. Bestuurdersaansprakelijkheid — grotendeels beantwoord

**D1.** ✅ **BEANTWOORD (memo 11 feb)**: Risico bestuurdersaansprakelijkheid Peter?
> **Antwoord jurist**: Positie "overwegend veilig." Tijdige ontslagname + waarschuwingsbrief 8 feb = Beklamel-norm afgedekt.

**D2.** ❔ **NIET MEER ACTIEF**: Structurele buitensluiting als verweer tegen bestuurdersaansprakelijkheid.
> **Status**: Niet nodig — Peter is al veilig onder Beklamel-norm.

**D3.** ✅ **BEANTWOORD (memo 11 feb)**: Douwine's aansprakelijkheidsdreiging (e-mail 1 feb).
> **Antwoord jurist**: Geen reële grondslag. Het is juist Douwine die risico loopt (New Holland Belgium-norm).

**D4.** ❔ **NIET MEER ACTIEF**: Jaarrekening 2024 tijdig gedeponeerd? Bewijsvermoeden Art. 2:248 lid 2 BW.
> **Status**: Achtergrondvraag. Peter is na 1 maart geen bestuurder meer; risico is afgedekt.

### E. Leningsovereenkomst — deels beantwoord, rest samengevoegd

**E1** → Samengevoegd in vraag 3.3.

**E2.** ❔ **TE GEDETAILLEERD**: Rente-accumulatie boven €500K als overtreding Art. 7.1.f.
> **Status**: Technische vraag, niet urgent voor huidige strategie.

**E3.** ❔ **TE GEDETAILLEERD**: Vernietiging addendum wegens misbruik van omstandigheden (Art. 3:44 lid 4 BW).
> **Status**: Achtergrondoptie, niet actief.

**E4.** ✅ **BEANTWOORD (memo 11 feb)**: Kan Freca verhaal halen op PHBX via bestuurdersaansprakelijkheid?
> **Antwoord jurist**: Nee. PHBX is geen partij. Peters risico is afgedekt door waarschuwingsbrief.

**E5.** 🔶 **DEELS BEANTWOORD**: Tegenstrijdig belang bij opeising lening.
> **Memo jurist**: Bevestigt tegenstrijdig belang als grond voor aansprakelijkheid. Specifieke werking bij opeising niet uitgewerkt.

**E6-E7.** ❔ **NIET MEER ACTIEF**: Ontslag Peter als "staking" onder Art. 7.1.g leningsovereenkomst.
> **Status**: Risico is afgedekt: MO wordt niet opgezegd (zie sectie 1.1), Peter doet KTLO.

### F. Vrijwaring en Aansprakelijkheidsbeperking — samengevoegd in sectie 1

**F1** → Samengevoegd in vraag 1.1. **F2** → Achtergrondvraag (pas relevant bij faillissement). **F3** → Samengevoegd in vraag 1.3.

### G. Ongerechtvaardigde Verrijking — samengevoegd in sectie 1

**G1** → Samengevoegd in vraag 1.3.

**G2.** ❔ **NIET MEER ACTIEF**: Verzwakt Peters instemming met AVA-besluit het argument?
> **Status**: Herlevingsclausule was expliciet tijdelijk. Subsidiair aan MO-strategie.

**G3.** ❔ **NIET MEER ACTIEF**: Ongerechtvaardigde verrijking als tegenwicht tegen leningsvordering.
> **Status**: Theoretisch relevant maar niet actief ingezet.

### H. Schijnconstructie Marlou — niet meer actief

**H1-H5** → Schijnconstructie-argumenten zijn achtergrondmateriaal. De teruglevering vindt plaats — focus ligt nu op voorwaarden co-signering (sectie 2).

### I. Uittreding Vorderen — niet meer actief

**I1-I4** → Art. 2:343 BW / enquêteprocedure zijn achtergrondopties. Huidige strategie is onderhandelde exit via package deal (sectie 2.6).

### J. Freca's Managementovereenkomst — samengevoegd

**J1-J2** → Deels verwerkt in vraag 3.2 (Freca's fee-status).

### K. Overig — niet meer actief

**K1.** ❔ Saldo-overzichten (Art. 9 leningsovereenkomst) — technisch, niet urgent.
> **Feitelijk**: Nee, Freca heeft geen jaarlijkse saldo-overzichten verstrekt. Geen bezwaar gemaakt. Geen juridisch vastgesteld saldo.

**K2.** ❔ Art. 11.3 uitsluiting ontbinding leningsovereenkomst — technisch, niet urgent.

**K3.** ❔ Belastingdienst informeren over €1 waardering — strategische reserve, niet actief.

### L. Concept Akte Teruglevering — grotendeels samengevoegd in sectie 2

**L3.** ❔ **NIET MEER ACTIEF**: Prijs bij uitoefening voorkeursrecht.
> **Status**: Peter overweegt geen uitoefening voorkeursrecht.

**L4c.** ✅ **BEANTWOORD (memo 11 feb)**: Boeteclausule Art. 10 SHA als tegenvordering.
> **Antwoord jurist**: Ja. Dit is de **"belangrijkste onderhandelingstroef."** Direct opeisbare boete van €100.000.

**L4b.** ❔ **NIET MEER ACTIEF**: Verdediging via Art. 6:248 lid 2 BW (beperkende werking r&b) — Peter is niet de partij die zich hoeft te verdedigen.

**L5.** ❔ **NIET MEER ACTIEF**: Prijsafwijking €1 vs €1,50 in akte — bevestigt stroman-karakter maar niet actief relevant.

### M. Grady Hofstra — strategische reserve

**M1-M4** → NBA-klacht is strategische reserve (niet voor nu, voor later als onderhandeling vastloopt). Analyse in `analyse/grady-hofstra-dynamiek.md`.

### N. KTLO-structurering — samengevoegd in secties 1-3

**N4.** ❔ **NIET MEER ACTIEF**: Erkenning lening door Peter persoonlijk.
> **Status**: Peter benoemde aflossing in context van Dinck's schuld, niet persoonlijk. Geen reëel risico.

**N7.** ❔ **NIET MEER ACTIEF**: Zeggenschap aandeelhouder over ontslaan werknemers (Art. 8.6 lid 2 vetorecht).
> **Status**: Na 1 maart is dit een bestuursbesluit. Peter kan via vetorecht blokkeren als het als AVA-besluit wordt voorgelegd, maar ontslagrecht werknemers is primair bestuursdomein.
